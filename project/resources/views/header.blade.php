			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="{{route('loai-san-pham')}}">Sản phẩm</a>
							<ul class="sub-menu">
								<li><a href="{{route('san-pham')}}">Sản phẩm 1</a></li>
								<li><a href="{{route('san-pham')}}">Sản phẩm 2</a></li>
								<li><a href="{{route('san-pham')}}">Sản phẩm 4</a></li>
							</ul>
						</li>
